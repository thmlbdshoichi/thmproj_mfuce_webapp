...
<head>
    ...
    <link rel="stylesheet" href="css/reg211.css">
        ...
        <div class="pad">
            ...
            <form action="insert_form.php" method="POST" style="font-family:ConcertOne;" onSubmit="JavaScript : return fncSubmit();">
                    ...
                    <div class="form-row mt-5">
                        <div class="form-group col-12">
                            ...
                            <div class="form-check form-check-inline mr-1">
                                <input class="form-check-input" type="radio" name="semesteroption" id="firstsemester" value="First" checked="checked">
                ...
                <div class="text-center">
                    <u><p class=" head1 mt-5" style="font-size:calc(0.5rem + 1vw);">(1) Student Information & Request</p></u>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-12  col-sm-4">
                        ...
                        <input type="tel" class="form-control" name="std_phone" id="std_phone" placeholder="087356xxxx">
                    </div>
                </div>

                <div class="text-center">
                    <u><p class=" head1 mt-5" style="font-size:calc(0.5rem + 1vw);">Reason(s) for maintaining student status are</p></u>
                </div>
                ...
                <div class="form-row mt-2">
                    <div class="form-group col-12">
                        ...
                        <input type="text" class="form-control reason" name="std_reason_other_explain" id="std_reason_other_explain" placeholder="Specify your reason here">
                    </div>
                </div>
                <br>
