...
<body>
    ...
    <div class="container">
        ...
        <!-- START FORM -->
        <form action="update_form_sql.php" method="POST" style="font-family:ConcertOne;" onSubmit="JavaScript : return fncSubmit();">
            <!-- TOP PART -->
            ...
            <div class="form-row">
                ...
                <div class="form-group col-12 col-sm-6">
                    ...
                    ?>  
                    <option value="<?= $SCHOOL_NAME ?>" <?php if($SCHOOL_NAME==$DEAN){ echo "selected=selected";} ?>> <?= $SCHOOL_NAME ?> </option>
                    <?php }
                        }
                    ?>
                    </select>
            ...
            <div class="form-row mt-5">
                ...
                <div class="form-group col-12 col-sm-6">
                    ...
                    <select name="std_level" id="std_level" class="form-control">
                        <option value="Undergraduate" <?php if($ST_LEVEL=="Undergraduate"){ echo "selected=selected";} ?>>Undergraduate Student</option>
                        <option value="Graduate" <?php if($ST_LEVEL=="Graduate"){ echo "selected=selected";} ?>>Graduate Student</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-sm-2">
                    ...
                    <select name="std_prefix" id="std_prefix" class="form-control">
                        <option value="Mr." <?php if($PREFIX=="Mr."){ echo "selected=selected";} ?> >Mr.</option>
                        <option value="Miss" <?php if($PREFIX=="Miss"){ echo "selected=selected";} ?> >Miss</option>
                        <option value="Mrs." <?php if($PREFIX=="Mrs."){ echo "selected=selected";} ?> >Mrs.</option>
                    </select>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-sm-6">
                    ...
                    ?>  
                    <option value="<?= $SCHOOL_NAME ?>" <?php if($SCHOOL_NAME==$SCHOOL){ echo "selected=selected";} ?> ><?= $SCHOOL_ID ?> - <?= $SCHOOL_NAME ?></option>
                    <?php }
                        }
                    ?>
                    </select>
                ...
                <div class="form-group col-sm-6">
                    ...
                    ?>  
                    <option value="<?= $PRO_NAME ?>" <?php if($PRO_NAME==$PROGRAM){ echo "selected=selected";} ?>><?= $PRO_SC_ID ?> - <?= $PRO_NAME ?></option>
                    <?php }
                        }
                    ?>
                    </select>
            ...
            <div class="form-row mt-2">
                ...
                <a href="list_form.php"><button type="button" class="btn btn-dark ml-3">Back</button></a>
            </div>
        </form>
        <br>
        <br>
